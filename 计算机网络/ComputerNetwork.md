...
![](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/messgae_header_packet.jpg)
...
![](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/delay.jpg)
...
![](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/体系结构.jpg)

##### ![OSI七层功能](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/OSI.png)
...
![](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/DataTransport.jpg)



#### TCP/IP体系结构协议簇

![TCP/IP协议簇示意](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/Protocol.jpg)

### 例：C/S工作方式说明

![](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/客户-服务器工作方式.jpg)
...
![](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/屏蔽双绞线.jpg)

### 同轴电缆

![](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/同轴电缆.jpg)

### 光缆

![](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/光纤.jpg)
...
![](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/频分复用和时分复用.jpg)
...
![计算机生成了可选文字: 以太网 交换机#1 以太网 交换机#2 图3·26在两个交换机之间兜圈子的帧](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/clip_image001.png)

 

**虚拟局域网VLAN virtual Lan**

![计算机生成了可选文字: LANI:(Al,A2，Bl，CD， LAN2:(A3,B2，(2)，LAN3.•（A4，B3,C3) 但这10个用户划分为三个工作组，也就是说划分为三个虚拟局域网VLANO即： VLANI:(Al,A3，(4)， VLAN2.•()l，B2，(3);VLAN3:（Cl，C2，(3)。 以太网 交换机 以太网 交换机 使用802．IQ帧格丆 以太网 交换机 以太网 交换机 图3．27 三个虚拟局域网VLANI，VLAN2和VLAN3的构成](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/clip_image002.png)
...
![image-20210225123021825](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20210225123021825.png)
...
![image-20210522154525352](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20210522154525352.png)
...
![image-20210225135155950](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20210225135155950.png)
...
![计算机生成了可选文字: (a)通过存储器](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/clip_image001-1622786631011.png)
...
![计算机生成了可选文字: (b)通过总线](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/clip_image001-1622786653851.png)
...
![计算机生成了可选文字: 互连网绍 (c)通过互连网络](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/clip_image002-1622786631012.png)
...
![BGP发言人和自治系统AS的关系](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/clip_image001-1622786812391.png)
...
![计算机生成了可选文字: 假定某个机构在两个相隔较远的场所建立了专用网A和B，其网络地址分别为专用地 址10．1.0．0和10．2．0、0。现在这两个场所需要通过公用的互联网构成一个VPNO 显然，每一个场所至少要有一个路由器具有合法的全球IP地址，如图4巧9（a）中的路由 器RI和R20这两个路由器和互联网的接口地址必须是合法的全球IP地址。路由器RI和R2 在专用网内部网络的接口地址则是专用网的本地地址。](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/clip_image001-1622786920843.png)

 ![image-20210604140936991](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20210604140936991.png)
...
![img](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/78310a55b319ebc4c57a3f358c26cffc1e17161f)
...
![TCP报文头](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/TCP报文头.png)
...
### TCP的三次握手和四次挥手
 ...
 <img src="https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/1158196-20180301190534920-1824529844.png" alt="img" style="zoom:150%;" /> 

![image-20201218154057991](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20201218154057991.png)
...
![img](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/1155315343-0.jpg)
...
![img](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/1155312401-1.jpg)
...
#### TCP连接的释放（四次挥手）
 ...
 ![img](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/1158196-20180301191028587-1027330495.png) 
...
![img](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/1734701-20191128151354571-1852334064.png)
...
![image-20201218144844554](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20201218144844554.png)
...
![image-20201218151113349](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20201218151113349.png)
...
![image-20201218153155799](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20201218153155799.png)
...
![image-20210315165944746](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20210315165944746.png)
...
![image-20210316100459208](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20210316100459208.png)
...
![image-20201230165900771](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20201230165900771.png)
...
![image-20210225135626890](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20210225135626890.png)
...
![img](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/13949989-dcf024be2733e725.png)
...
![image-20210111221338914](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/image-20210111221338914.png)
...
![img](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/733013-20171003141732271-400909384.png)
...
组播，也叫多播，把信息同时传递给一组目的地址，IP网络的多播一般通过多播IP地址来实现。多播IP地址就是D类IP地址，即**224.0.0.0至239.255.255.255**之间的IP地址。Windows 2000中的DHCP管理器支持多播IP地址的自动分配。

广播：目的地址为网络中所有设备。在IP网络中，广播地址用IP地址“255.255.255.255”来表示，这个IP地址代表同一子网内所有的IP地址。
...
![img](https://ywy-imgsubmit.oss-cn-shanghai.aliyuncs.com/img/112P63295-0.jpg)
